...
- 🔭 **Currently Building:** Autonomous Text-to-SQL Engines & Distributed Inference Gateways.
- 💡 **Core Competency:** Optimizing Python backends for high-concurrency AI workloads.
- 🌱 **Learning:** Agentic Workflow Orchestration & Multi-Model Routing.
